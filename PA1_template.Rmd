...
paste("The mean number of steps taken per day is:", meanOfSteps, ", and the median is:", medianOfSteps, ". The median value differs from the estimates from the first part of the assignment.")
```
